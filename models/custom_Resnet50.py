...
from .deformable_convolution_layer import DeformableConvLayer as DeformConv
...
def block1(x, filters, kernel_size=3, stride=1,
    ...
    if conv_shortcut is True:
        ...
        shortcut = x
    #x = DeformConv(filters = filters, kernel_size=1, strides= stride, name=name + '_1_conv', num_deformable_group=1, dynamic= True)(x)
